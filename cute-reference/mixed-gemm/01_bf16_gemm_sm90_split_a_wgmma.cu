 ...
 *   - No A smem allocation or TMA pipeline for A
 *   - TMA pipeline for B only
 *   - warpgroup_wait<0>() after each k_tile's WGMMA loop (ensures all pending
 *     WGMMA complete before overwriting A registers and releasing B pipeline stage)
 *
 * Target: SM90
 **************************************************************************************************/
